...
--hl.bind(mainMod .. " + M", hl.dsp.exec_cmd("command -v hyprshutdown >/dev/null 2>&1 && hyprshutdown || hyprctl dispatch 'hl.dsp.exit()'")) --disabled in LXQt
...
hl.bind("SUPER + Super_L", hl.dsp.exec_cmd("lxqt-qdbus openmenu"), {release = true})
...
hl.bind("XF86AudioRaiseVolume", hl.dsp.exec_cmd("lxqt-qdbus volume up"), { locked = true, repeating = true })
hl.bind("XF86AudioLowerVolume", hl.dsp.exec_cmd("lxqt-qdbus volume down"),      { locked = true, repeating = true })
hl.bind("XF86AudioMute",        hl.dsp.exec_cmd("lxqt-qdbus volume mute"),     { locked = true, repeating = true })
hl.bind("XF86AudioMicMute",     hl.dsp.exec_cmd("wpctl set-mute @DEFAULT_AUDIO_SOURCE@ toggle"),   { locked = true, repeating = true })
hl.bind("XF86MonBrightnessUp",  hl.dsp.exec_cmd("lxqt-config-brightness -i"),                  { locked = true, repeating = true })
hl.bind("XF86MonBrightnessDown",hl.dsp.exec_cmd("lxqt-config-brightness -d"),                  { locked = true, repeating = true })
...
hl.layer_rule({ match = { namespace = "^(launcher|dialog|dropdown_terminal)$" }, dim_around = true })
hl.layer_rule({ match = { namespace = dropdown_terminal }, animation = "slide top" })
